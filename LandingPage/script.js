...
document.addEventListener('DOMContentLoaded', () => {
	const animatedElements = document.querySelectorAll('.projeto-card, .sobre-content, .contato-content');
...
const revealElements = document.querySelectorAll('.projeto-card, .sobre-content, .contato-content');
...
// Efeito de partículas sutil no background (opcional)
